...
interface AddRfpMonitoringModalProps {
  isOpen: boolean;
  isClosing: boolean;
  nextSeriesNumber: number;
  newRecord: Partial<RfpMonitoringRecord>;
  statuses: RfpStatus[];
  onClose: () => void;
...
const AddRfpMonitoringModal: React.FC<AddRfpMonitoringModalProps> = ({
  isOpen,
  isClosing,
  nextSeriesNumber,
  newRecord,
    ...
    <>
      ...
      <div className={`transaction-detail-modal ${isClosing ? 'closing' : ''}`} onClick={e => e.stopPropagation()}>
        <div className="transaction-modal-header">
          <span className="transaction-modal-title">Add New RFP Record</span>
        ...
        <div className="transaction-modal-content">
          ...
          <div className="transaction-modal-details">
            <div className="transaction-modal-detail-row">
              ...
              <input
                ...
                value={newRecord.cwrProcessed || `eRFP${nextSeriesNumber}`}
                onChange={e => onChange('cwrProcessed', e.target.value)}
                placeholder={`eRFP${nextSeriesNumber}`}
              />
            </div>
            ...
            <div className="transaction-modal-detail-row">
              ...
              <select
                className="transaction-modal-detail-value"
                value={newRecord.trampsysStatus || 'DRAFT'}
            ...
            <div className="transaction-modal-detail-row">
              ...
              <input
                type="text"
                className="transaction-modal-detail-value"
                value={newRecord.payeePerTrampsys || ''}
            ...
            <div className="transaction-modal-detail-row">
              ...
              <input
                type="text"
                className="transaction-modal-detail-value"
                value={newRecord.currencyInCwr || 'PHP'}
          ...
          <div style={{ marginTop: '1rem', display: 'flex', gap: '0.5rem', justifyContent: 'flex-end' }}>
            ...
            <button onClick={onSave} className="transaction-edit-save-button">Add RFP Record</button>
          </div>
        </div>
      </div>
    </>
...
export default AddRfpMonitoringModal;
